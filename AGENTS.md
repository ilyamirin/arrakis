...
- Актуальные live-параметры: `8x8`, `20 amber` на поле, цель `18 amber`, `Sinkjaw` radius `4`.
...
- Эта формула вместе с целью `18 amber` откалибрована под `~50%` побед для эвристического игрока, который обычно закрывает выигрышный забег за `25-30` ходов.
