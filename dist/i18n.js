const EN_COPY = {
    ...
    metaDescription: "Amber Dunes Harvest is a retro-futurist desert game shaped with AI-generated code, art, music, copy, and interface. Guide the Collector across a 6x6 grid in the Amber Waste, gather every amber deposit, and stay ahead of Sinkjaw.",
    ogDescription: "A retro-futurist desert game by Ilya Mirin with AI-generated code, art, music, copy, and interface. Guide the Collector through the Amber Waste, gather amber, and outlast Sinkjaw on a 6x6 board.",
...
const RU_COPY = {
    htmlLang: "ru",
    title: "Amber Dunes Harvest",
    metaDescription: "Amber Dunes Harvest — ретрофутуристическая пустынная игра с AI-generated кодом, артом, музыкой, текстами и интерфейсом. Проведите Collector по сетке 6x6 через The Amber Waste, соберите весь amber и уклонитесь от ударов Sinkjaw.",
    ogDescription: "Ретрофутуристическая пустынная игра Ильи Мирина с AI-generated кодом, артом, музыкой, текстами и интерфейсом. Проведите Collector через The Amber Waste, соберите amber и переживите удары Sinkjaw на поле 6x6.",
...
const TR_COPY = {
    htmlLang: "tr",
    title: "Amber Dunes Harvest",
    metaDescription: "Amber Dunes Harvest, yapay zekâyla üretilmiş kod, görseller, müzik, metinler ve arayüzle hazırlanmış retro-fütüristik bir çöl oyunudur. Collector'ı 6x6 tahtada Amber Waste boyunca yönlendirin, amber toplayın ve Sinkjaw saldırılarından kaçının.",
    ogDescription: "Ilya Mirin imzalı retro-fütüristik çöl oyunu. Yapay zekâyla üretilmiş kod, görseller, müzik, metinler ve arayüzle Amber Waste'te amber toplayın ve 6x6 tahtada Sinkjaw saldırılarından kurtulun.",
